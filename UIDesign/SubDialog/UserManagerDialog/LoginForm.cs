...
namespace AdaWeldSystem.Sub1UI
{
    ...
    /// 交互逻辑（校验、权限切换）保持不变。
    /// </summary>
    public partial class LoginForm : System.Windows.Forms.UserControl
    {
        ...
        public LoginForm(Window _window)
        {
            Window = _window;
            InitializeComponent();
        ...
        {
            using (UserEditForm editPassword = new UserEditForm(this.Window))
            {
